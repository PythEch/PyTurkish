...
"""
    ...
    _istisna={"kök":{"şu":"şun", "bu":"bun", "o":"on"},#Ek aldıklarında kökü değişen sözcükler
              ...
              "ünlü":{"renk":"reng", "cenk":"ceng", "his":"hiss", "isim":"ism", "beyin":"beyn", "boyun":"boyn", "karın":"karn", "af":"aff",
                    ...
                    "resim":"resm", "kayın":"kayn", "kayıp":"kayb", "nabız":"nabz", "ret":"redd", "kalp":"kalb"}, #Sadece ünlü ek aldıklarında kökü değişen sözcükler (ünlü düşmesi)
              ...
              "büu": ("kontrol", "bandrol", "banal", "alpul", "ametal", "anormal", "amiral"
                       ...
                       , "kolestrol", "kıraat", "ziraat", "kapital", "katedral", "kabul", "kanaat", "jurnal"
    ...
    #İyelik Ekleri
    def benim(self):
        """1. tekil şahıs iyelik eki"""
        self.__ek="m"
        self.__kaynastirma="i"
        return self.__isle__()
        
    def senin(self):
        """2. tekil şahıs iyelik eki"""
        self.__ek="n"
        self.__kaynastirma="i"
        return self.__isle__()
